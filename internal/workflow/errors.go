...
var (
	...
	ErrInvalidStateTarget        = errors.New("target is not a defined state or terminal (done, cancelled, failed)")
	...
	ErrNestedRunScript           = errors.New("nested run_script: add multiple commands to the commands list instead")
